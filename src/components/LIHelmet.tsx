...
export default function LIHelment(props: { title?: string, description?: string, URL?: string, imageURL?: string }) {
    return (
        <Helmet>
            <title>{props.title || 'LevelImposter'}</title>
            <meta property='og:title' content={props.title || 'LevelImposter'} />
            <meta property='og:description' content={props.description || 'LevelImposter is a free, open-source, and easy to use level editor for the game Among Us.'} />
