...
export class VentGenerator {
    ...
    setValues() {
        ...
        currentItem.name = $("#ventNameInput").val();
        currentItem.targetIds[0] = parseInt($("#ventInput1").val());
        currentItem.targetIds[1] = parseInt($("#ventInput2").val());
        currentItem.targetIds[2] = parseInt($("#ventInput3").val());
